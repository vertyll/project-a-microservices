// =========================================================================
// task-contracts — Published Language module (DDD).
// =========================================================================
plugins {
    java
    `java-library`
...
description = "Task bounded-context Avro contracts"
...
val avroContractsDir = file("$rootDir/../contracts/task-service")
...
val generateAvroJava by tasks.registering(JavaExec::class) {
    group = "build"
    description = "Generate Java SpecificRecord classes from all Avro schemas owned by the task bounded context."
    inputs
        .files(avroSchemas)
