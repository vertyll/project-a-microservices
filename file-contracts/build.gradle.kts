// =========================================================================
// file-contracts — Published Language module (DDD).
// =========================================================================
plugins {
    java
    `java-library`
...
description = "File bounded-context Avro contracts"
...
val generateAvroJava by tasks.registering(JavaExec::class) {
    group = "build"
    description = "Generate Java SpecificRecord classes from all Avro schemas owned by the file bounded context."
    inputs
        .files(avroSchemas)
