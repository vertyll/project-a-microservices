...
/**
 * Global exception handler for role service.
 * Provides consistent error responses across the role service.
 */
@RestControllerAdvice(basePackages = ["com.vertyll.projecta.role"])
