// =========================================================================
// project-contracts — Published Language module (DDD).
// =========================================================================
plugins {
    java
    `java-library`
...
description = "Project bounded-context Avro contracts"
...
val avroContractsDir = file("$rootDir/../contracts/project-service")
...
val generateAvroJava = tasks.register<JavaExec>("generateAvroJava") {
    group = "build"
    description = "Generate Java SpecificRecord classes from all Avro schemas owned by the project bounded context."
    inputs
        .files(avroSchemas)
