...
description = "Transactional outbox, idempotent consumption and Avro serialisation over Kafka"
...
dokka {
    ...
    dokkaPublications.named("html") {
        outputDirectory.set(rootProject.layout.projectDirectory.dir("../docs/dokka/shared-messaging-kafka"))
    }
    dokkaSourceSets.named("main") {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/vertyll/veds/tree/main/shared-messaging-kafka/src/main/kotlin")
